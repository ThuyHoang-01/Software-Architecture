...
public class UIList extends JFrame {
	...
	public UIList() {
		...
		btnThem.setBounds(174, 160, 89, 23);
		contentPane.add(btnThem);
		
		JButton btnGui = new JButton("Gui");
		btnGui.setBounds(174, 207, 89, 23);
		...
		btnGui.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {	
				...
				try {
					...
					producer.send(msg);
					xml = new XMLConvert<Persons>(persons).object2XML(persons);
