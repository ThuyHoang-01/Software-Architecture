...
namespace Reciever
{
    public partial class Form1 : Form
    {
        ...
        private void listBox1_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            for (int j = 0; j < listBN.Count; j++)
            {
                if (_id == listBN[j].BenhNhanId)
                {
                    ...
                    this.textBox2.Text = listBN[j].soCMND;
                    this.textBox3.Text = listBN[j].HovaTen;
                    this.richTextBox1.Text = listBN[j].DiaChi;
        ...
        private void button2_Click(object sender, System.EventArgs e)
        {
            ...
            m[4] = "Địa chỉ:" + this.richTextBox1.Text;
            m[5] = "Ghi chú:" + this.richTextBox1.Text;
